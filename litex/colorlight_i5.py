...
from litex_wrapper_produto_escalar import ProdutoEscalar
...
class BaseSoC(SoCCore):
    def __init__(self, board="i5", revision="7.0", toolchain="trellis", sys_clk_freq=60e6,
        ...
        **kwargs):
        ...
        # Adiciona o diretório RTL para garantir que o SystemVerilog seja encontrado
        platform.add_source_dir(os.path.join(
