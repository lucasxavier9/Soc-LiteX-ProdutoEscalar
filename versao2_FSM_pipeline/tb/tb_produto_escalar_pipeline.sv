...
module tb_produto_escalar;
    ...
    initial begin
        ...
        $display("==========================================");
        $display("   TESTBENCH V2 - PIPELINE BÁSICO");
        $display("==========================================");
        ...
        $display("Resultado: %0d | Esperado: 204", $signed(resultado));
        if ($signed(resultado) == 204) begin
        ...
        $display("Resultado: %0d | Esperado: 0", $signed(resultado));
        if ($signed(resultado) == 0) begin
            $display("TESTE PASSOU!");
        end else begin
            $display("TESTE FALHOU!");
        end
